...
public class ProductDaoJdbc implements ProductDao {
    ...
    public List<Product> getBy(Supplier supplier) {
        try (Connection conn = dataSource.getConnection()) {
            String sql = "SELECT products.product_id,products.product_name, products.product_description, products.product_defaultprice, products.product_currency,cat.category_name,products.product_picture,s.suplier_name FROM products JOIN category cat on cat.category_id = products.product_category_id JOIN supplier s on s.suplier_id = products.product_supplier_id WHERE s.suplier_name = ?;";
